...
p.add_argument('params', nargs='+', help='file:name=min:max, e.g. WP_Baseline_InflowWind_12mps.dat:HWindSpeed=5:20')
p.add_argument('-n', type=int, required=True)
p.add_argument('--fst', default=None, help='defaults to the only .fst in the folder')
